          ...
          <div class="row">
            ...
            <div class="col-lg-6 bg-white">
              <div class="form d-flex align-items-center">
                <div class="content">
                  <form class="form-validate" action="register" ModelAttribute="user" method="post" >
                    ...
                    <div class="form-group">
                      <input type="submit" id="regidter" name="registerSubmit" value="Register" class="btn btn-primary"/>
                    </div>
                    <div class="form-group">
